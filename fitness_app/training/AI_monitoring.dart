...
import 'package:best_flutter_ui_templates/hotel_booking/monitoring_list_view.dart'; //여기서 형식 가져오고 
...
class ai_monitoring extends StatefulWidget {
  const ai_monitoring({Key? key, this.animationController}) : super(key: key);

  final AnimationController? animationController;
  @override
  _ai_monitoring createState() => _ai_monitoring();
}

//얘가 호텔 카드 구현해놓은 부분
class _ai_monitoring extends State<ai_monitoring>
